export const WindCompass = ({ windSpeed , windDirection }) => {
  return (
    <div className="relative -mt-5 flex h-[10rem] w-[10rem] items-center justify-center md:-mt-5 md:h-[9rem] md:w-[9rem]">
      {/* Wind Speed Display */}
      <div className="absolute text-sm font-semibold">{windSpeed}kt</div>
      ...
      >
        <g fill="none" fillRule="evenodd" opacity=".401">
          ...
          <path stroke="#000" strokeLinecap="square" strokeLinejoin="bevel" strokeWidth="2" d="m11.421 250 .158 17.999" transform="translate(154 31)" />
          ...
          <g stroke="#000" strokeLinecap="square" strokeLinejoin="bevel" strokeWidth="2">
      ...
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 331 331" 
        className="absolute invert transition-transform ease-in-out will-change-transform duration-500" 
