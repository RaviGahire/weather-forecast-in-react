...
<section 
    ...
    >
      ...
      <div className="flex-1 w-full text-center lg:text-left mb-8 lg:mb-0 max-w-2xl lg:max-w-none">
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-900 mb-3 sm:mb-4 px-2 sm:px-0">
        ...
        <p className='text-sm sm:text-base text-neutral-600 my-3 sm:my-4'>
